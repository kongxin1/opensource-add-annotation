...
public final class OpenWireFormat implements WireFormat {
	...
	public String toString() {
		return "OpenWireFormat{version=" + version + ", cacheEnabled=" + cacheEnabled + ", stackTraceEnabled="
				+ stackTraceEnabled + ", tightEncodingEnabled=" + tightEncodingEnabled + ", sizePrefixDisabled="
	...
	public synchronized Object unmarshal(ByteSequence sequence) throws IOException {
		...
		if (!sizePrefixDisabled) {
			...
			if (size > maxFrameSize) {
				throw new IOException("Frame size of " + (size / (1024 * 1024)) + " MB larger than max allowed "
	...
	public void setVersion(int version) {
		...
		try {
			...
			throw (IllegalArgumentException) new IllegalArgumentException("Invalid version: " + version
					+ ", could not load " + mfName).initCause(e);
		}
		try {
