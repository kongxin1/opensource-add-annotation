 ...
 */
/**
 * 一个LRU缓存器，默认最多存储1w，该类目前找到了一个实现MemoryTopicMessageStoreLRUCache，但是没有发现删除元素的操作
 * @ClassName: LRUCache
 * @Description: TODO
 * @author: 孔新
 * @date: 2016年7月31日 下午2:12:05
 * @param <K>
 * @param <V>
 */
public class LRUCache<K, V> extends LinkedHashMap<K, V> {
	...
	/**
	 * Constructs an empty <tt>LRUCache</tt> instance with the specified initial capacity,
