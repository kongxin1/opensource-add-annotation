...
public class RecoverableRandomAccessFile implements java.io.DataOutput, java.io.DataInput, java.io.Closeable {
	private static final boolean SKIP_METADATA_UPDATE = Boolean
			.getBoolean("org.apache.activemq.kahaDB.files.skipMetadataUpdate");
	...
	@Override
	/**
	 * 将bytes数组中的内容从i位置开始将i2个字节内容写入磁盘
	 */
