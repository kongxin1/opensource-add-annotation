...
public class StringArrayConverter {
	 ...
	 * @Description: 将value转化为对应String数组，要求value的toString方法返回值是以’，‘分割，分割出的每一个值作为String数组中 的一个元素
	 * @author: 孔新
	 * @date: 2016年7月1日 下午10:08:33
	 */
	 ...
	 * @Description: 用于将value转化为String，其实就是将数组中的值直接拼接成一个字符串，中间使用’，‘分割
	 * @param value
	 * @return
	 * @return: String
	 */
