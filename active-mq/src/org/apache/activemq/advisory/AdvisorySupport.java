...
public final class AdvisorySupport {
	...
	public static final String VIRTUAL_DESTINATION_CONSUMER_ADVISORY_TOPIC_PREFIX = ADVISORY_TOPIC_PREFIX
	...
	public static final String QUEUE_VIRTUAL_DESTINATION_CONSUMER_ADVISORY_TOPIC_PREFIX = VIRTUAL_DESTINATION_CONSUMER_ADVISORY_TOPIC_PREFIX
			+ "Queue.";
	public static final String TOPIC_VIRTUAL_DESTINATION_CONSUMER_ADVISORY_TOPIC_PREFIX = VIRTUAL_DESTINATION_CONSUMER_ADVISORY_TOPIC_PREFIX
			+ "Topic.";
	...
	public static final String NETWORK_BRIDGE_FORWARD_FAILURE_TOPIC_PREFIX = NETWORK_BRIDGE_TOPIC_PREFIX
			+ ".ForwardFailure";
	...
	/**
	 * 返回一个名字为“ActiveMQ.Advisory.MasterBroker”的topic
	 * @Title: getMasterBrokerAdvisoryTopic
	 * @Description: TODO
	 * @return
	...
	/**
	 * 判断入参是不是一个发现ActiveMQDestination对象，如果入参不是一个组合destination，则根据destination的物理地址判断即可，如果是组合对象，
	 * 对组合对象中的每一个destination进行判断，如果有一个是，那么就返回true
	 * @Title: isAdvisoryTopic
	 * @Description: TODO
	 * @param destination
	 * @return
	 * @return: boolean
	...
	public static boolean isVirtualDestinationConsumerAdvisoryTopic(Destination destination) throws JMSException {
		return isVirtualDestinationConsumerAdvisoryTopic(ActiveMQMessageTransformation
	...
	public static boolean isVirtualDestinationConsumerAdvisoryTopic(ActiveMQDestination destination) {
		if (destination.isComposite()) {
			...
			return destination.isTopic()
					&& destination.getPhysicalName().startsWith(VIRTUAL_DESTINATION_CONSUMER_ADVISORY_TOPIC_PREFIX);
		}
	}
	...
	/**
	 * 判断入参是不是masterbroker，是根据destination的名字前缀进行判断的
	 * @Title: isMasterBrokerAdvisoryTopic
	 * @Description: TODO
	 * @param destination
	 * @return
	 * @return: boolean
