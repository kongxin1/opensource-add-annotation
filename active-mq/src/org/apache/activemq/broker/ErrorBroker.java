 ...
 */
/**
 * 这是一个不能使用的Broker对象，里面的方法如果使用都会抛出异常
 * @ClassName: ErrorBroker
 * @Description: TODO
 * @author: 孔新
 * @date: 2016年7月15日 下午7:49:33
 */
public class ErrorBroker implements Broker {
	...
	@Override
	public Destination addDestination(ConnectionContext context, ActiveMQDestination destination, boolean flag)
			throws Exception {
		throw new BrokerStoppedException(this.message);
	}
	@Override
