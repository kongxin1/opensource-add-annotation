...
/**
 * 记录三个不同的地址的消息个数
 * @ClassName: RegionStatistics
 * @Description: TODO
 * @author: 孔新
 * @date: 2016年7月16日 下午10:11:54
 */
public class RegionStatistics extends StatsImpl {
	...
	public RegionStatistics(boolean enabled) {
		advisoryDestinations = new CountStatisticImpl("advisoryTopics",
				"The number of advisory destinations in the region");
		destinations = new CountStatisticImpl("destinations",
				"The number of regular (non-adivsory) destinations in the region");
		allDestinations = new CountStatisticImpl("allDestinations",
				"The total number of destinations, including advisory destinations, in the region");
