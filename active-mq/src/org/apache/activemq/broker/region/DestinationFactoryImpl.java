...
/**
 * 本对象需要一个持久化适配器
 * @ClassName: DestinationFactoryImpl
 * @Description: TODO
 * @author: 孔新
 * @date: 2016年7月13日 下午10:40:38
 */
public class DestinationFactoryImpl extends DestinationFactory {
	...
	public DestinationFactoryImpl(BrokerService brokerService, TaskRunnerFactory taskRunnerFactory,
	...
	@Override
	/**
	 * 根据Destination入参的类型创建对应的queue或者topic，并使用Destination入参的policyentry进行配置
	 */
	...
	/**
	 * 对queue入参根据destination入参进行配置，是根据PolicyEntry对象做的
	 * @Title: configureQueue
	 * @Description: TODO
	 * @param queue
	 * @param destination
	 * @return: void
	...
	@Override
	/**
	 * 返回持久化适配器中，最后一个broker的序列id，猜测每一个broker对象都有一个对象的整数id
	 */
