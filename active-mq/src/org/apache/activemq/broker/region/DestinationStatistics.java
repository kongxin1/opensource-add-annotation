 ...
 */
/**
 * 计数器集合，里面使用多个计数器，每个计数器对应一个属性
 * @ClassName: DestinationStatistics
 * @Description: TODO
 * @author: 孔新
 * @date: 2016年7月7日 下午9:39:47
 */
public class DestinationStatistics extends StatsImpl {
	...
	public DestinationStatistics() {
		...
		forwards = new CountStatisticImpl("forwards",
				"The number of messages that have been forwarded to a networked broker from the destination");
		...
		consumers = new CountStatisticImpl("consumers",
