 ...
 */
/**
 * 里面存储了；两个属性，这两个属性用于存储即将发送的消息，可以通过本类对里面存储的消息进行处理
 * @ClassName: QueueDispatchPendingList
 * @Description: TODO
 * @author: 孔新
 * @date: 2016年8月9日 下午8:41:01
 */
public class QueueDispatchPendingList implements PendingList {
	...
	/**
	 * Messages added are added directly to the pagedInPendingDispatch set of messages. If you're
	 * trying to add a message that is marked redelivered add it using addMessageForRedelivery()
	 * method
	 * @param message The MessageReference that is to be added to this list.
