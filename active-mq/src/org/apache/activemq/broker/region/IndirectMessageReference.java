 ...
 */
/**
 * 负责追踪消息，从消息的属性中可以很容易的看出
 * @ClassName: IndirectMessageReference
 * @Description: TODO
 * @author: 孔新
 * @date: 2016年7月31日 下午1:44:51
 */
public class IndirectMessageReference implements QueueMessageReference {
	...
	public String toString() {
		return "Message " + message.getMessageId() + " dropped=" + dropped + " acked=" + acked + " locked="
				+ (lockOwner != null);
	}
