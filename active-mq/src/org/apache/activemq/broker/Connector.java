...
public interface Connector extends Service {
	...
	/**
	 * @return true if clients should be updated when a broker is removed from a broker
	 */
	 ...
	 */
	/**
	 * 是否允许将旧的连接替换为新的连接对象，如果允许的话，旧连接对象会被stop掉
	 * @Title: isAllowLinkStealing
	 * @Description: TODO
	 * @return
	 * @return: boolean
	 */
	...
	/**
	 * @return The comma separated string of regex patterns to match broker names for cluster client
	 *         updates
	 */
