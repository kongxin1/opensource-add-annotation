...
public class TransportConnector implements Connector, BrokerServiceAware {
	...
	// 记录同一个connectionid下最多有多少个consumer
	...
	/**
	 * 默认调用的是这个方法
	 * @Title:TransportConnector
	 * @Description:TODO
	 */
	public TransportConnector() {
	}
	/**
	 * 对TransportServer进行封装，一个TransportConnector对应一个TransportServer
	 * @Title:TransportConnector
	 * @Description:TODO
	 * @param server
	 */
	...
	/**
	 * Sets the server transport URI to use if there is not a {@link TransportServer} configured via
	 * the {@link #setServer(TransportServer)} method. This value is used to lazy create a
	 * {@link TransportServer} instance
	 * @param uri
	 */
	...
	/**
	 * 得到一个可以对外发布的uri
	 * @Title: getPublishableConnectString
	 * @Description: TODO
	 * @return
	 * @throws Exception
	 * @return: String
	...
	/**
	 * @param updateClusterFilter the updateClusterFilter to set
	 */
	...
	/**
	 * Enable a producer audit on network connections, Traps the case of a missing send reply and
	 * resend. Note: does not work with conduit=false, networked composite destinations or networked
	 * virtual topics
