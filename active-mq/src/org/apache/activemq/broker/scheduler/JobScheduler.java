...
public interface JobScheduler {
	...
	/**
	 * Starts dispatch of scheduled Jobs to registered listeners. Any listener added after the start
	 * dispatch method can miss jobs so its important to register critical listeners before the
	 * start of job dispatching.
	 * @throws Exception
	 */
	 ...
	 * @param listener The job listener to add.
	 * @throws Exception
	 */
	void addListener(JobListener listener) throws Exception;
	/**
	 * remove a JobListener that was previously registered. If the given listener is not in the
	 * registry this method has no effect.
	 * @param listener The listener that should be removed from the listener registry.
	 * @throws Exception
	 */
	 ...
	 * @param jobId a unique identifier for the job
	 * @param payload the message to be sent when the job is scheduled
	 * @param cronEntry The cron entry to use to schedule this job.
	 * @throws Exception if an error occurs while scheduling the Job.
	 */
	 ...
	 * @throws Exception
	 */
	void schedule(String jobId, ByteSequence payload, String cronEntry, long delay, long period, int repeat)
			throws Exception;
	/**
	 * remove all jobs scheduled to run at this time
	 * @param time The UTC time to use to remove a batch of scheduled Jobs.
	 * @throws Exception
	 */
	void remove(long time) throws Exception;
	/**
	 * remove a job with the matching jobId
	 * @param jobId The unique Job Id to search for and remove from the scheduled set of jobs.
