...
public abstract class NetworkConnector extends NetworkBridgeConfiguration implements Service {
	...
	// -------------------------------------------------------------------------
	/**
	 * 将本对象中的DynamicallyIncludedDestination，ExcludedDestination，StaticallyIncludedDestination，
	 * DurableDestination设置到DemandForwardingBridgeSupport对象中，上述四个都是可以在配置文件中配置的，并且都有对应的标签
	...
	/**
	 * 启动该对象，必须设置localURI属性，是在配置文件中配置的
	 * @Title: handleStart
	 * @Description: TODO
	 * @throws Exception
	 * @return: void
