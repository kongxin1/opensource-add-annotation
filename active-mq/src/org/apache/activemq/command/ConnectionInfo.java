...
public class ConnectionInfo extends BaseCommand {
	...
	/**
	 * Transports may wish to associate additional data with the connection. For example, an SSL
	 * transport may use this field to attach the client certificates used when the connection was
	 * established.
