 ...
 */
/**
 * 发送消息的对象，在这个对象中持有需要发送的消息
 * @ClassName: ActiveMQMessage
 * @Description: TODO
 * @author: 孔新
 * @date: 2016年7月16日 下午1:47:42
 */
public class ActiveMQMessage extends Message implements org.apache.activemq.Message, ScheduledMessage {
	...
	// 下面这个属性中存储了一部分可以设置本对象中某些属性值的方法，可以通过调用这些方法设置属性值
	...
	@SuppressWarnings("rawtypes")
	/**
	 * 获得当前对象中所有属性的名字，包括JMS_PROPERTY_SETERS属性中的内容
	...
	// 下面的方法基本都是将类型转化完毕后，通过调用本对象的set方法设置进message对象中
	static {
		JMS_PROPERTY_SETERS.put("JMSXDeliveryCount", new PropertySetter() {
			...
			public void set(Message message, Object value) throws MessageFormatException {
				...
				if (rc == null) {
					throw new MessageFormatException("Property JMSXDeliveryCount cannot be set from a "
		...
		JMS_PROPERTY_SETERS.put("JMSXGroupID", new PropertySetter() {
			...
			public void set(Message message, Object value) throws MessageFormatException {
				...
				if (rc == null) {
					throw new MessageFormatException("Property JMSXGroupID cannot be set from a "
							+ value.getClass().getName() + ".");
				}
		...
		JMS_PROPERTY_SETERS.put("JMSXGroupSeq", new PropertySetter() {
			...
			public void set(Message message, Object value) throws MessageFormatException {
				Integer rc = (Integer) TypeConversionSupport.convert(value, Integer.class);
				if (rc == null) {
					throw new MessageFormatException("Property JMSXGroupSeq cannot be set from a "
							+ value.getClass().getName() + ".");
				}
		...
		JMS_PROPERTY_SETERS.put("JMSCorrelationID", new PropertySetter() {
			...
			public void set(Message message, Object value) throws MessageFormatException {
				String rc = (String) TypeConversionSupport.convert(value, String.class);
				if (rc == null) {
					throw new MessageFormatException("Property JMSCorrelationID cannot be set from a "
							+ value.getClass().getName() + ".");
				}
		...
		JMS_PROPERTY_SETERS.put("JMSDeliveryMode", new PropertySetter() {
			...
			public void set(Message message, Object value) throws MessageFormatException {
				...
				if (rc == null) {
					...
					if (bool == null) {
						throw new MessageFormatException("Property JMSDeliveryMode cannot be set from a "
								+ value.getClass().getName() + ".");
					} else {
		...
		JMS_PROPERTY_SETERS.put("JMSExpiration", new PropertySetter() {
			...
			public void set(Message message, Object value) throws MessageFormatException {
				...
				if (rc == null) {
					throw new MessageFormatException("Property JMSExpiration cannot be set from a "
							+ value.getClass().getName() + ".");
				}
		...
		JMS_PROPERTY_SETERS.put("JMSPriority", new PropertySetter() {
			...
			public void set(Message message, Object value) throws MessageFormatException {
				Integer rc = (Integer) TypeConversionSupport.convert(value, Integer.class);
				if (rc == null) {
					throw new MessageFormatException("Property JMSPriority cannot be set from a "
							+ value.getClass().getName() + ".");
				}
		...
		JMS_PROPERTY_SETERS.put("JMSRedelivered", new PropertySetter() {
			...
			public void set(Message message, Object value) throws MessageFormatException {
				...
				if (rc == null) {
					throw new MessageFormatException("Property JMSRedelivered cannot be set from a "
							+ value.getClass().getName() + ".");
				}
		...
		JMS_PROPERTY_SETERS.put("JMSReplyTo", new PropertySetter() {
			...
			public void set(Message message, Object value) throws MessageFormatException {
				...
				if (rc == null) {
					throw new MessageFormatException("Property JMSReplyTo cannot be set from a "
							+ value.getClass().getName() + ".");
				}
		...
		JMS_PROPERTY_SETERS.put("JMSTimestamp", new PropertySetter() {
			...
			public void set(Message message, Object value) throws MessageFormatException {
				Long rc = (Long) TypeConversionSupport.convert(value, Long.class);
				if (rc == null) {
					throw new MessageFormatException("Property JMSTimestamp cannot be set from a "
							+ value.getClass().getName() + ".");
				}
		...
		JMS_PROPERTY_SETERS.put("JMSType", new PropertySetter() {
			...
			public void set(Message message, Object value) throws MessageFormatException {
				String rc = (String) TypeConversionSupport.convert(value, String.class);
				if (rc == null) {
					throw new MessageFormatException("Property JMSType cannot be set from a "
							+ value.getClass().getName() + ".");
				}
	...
	/**
	 * 校验入参的类型是否合法，如果是八种基本类型及其包装类，或者是ActiveMQConnection对象允许的map，list类型都是合法的，其他的都是非法
	 * @Title: checkValidObject
	 * @Description: TODO
	 * @param value
			...
			if (conn == null || conn.isNestedMapAndListEnabled()) {
				if (!(value instanceof Map || value instanceof List)) {
					throw new MessageFormatException(
							"Only objectified primitive objects, String, Map and List types are allowed but was: "
	...
	/**
	 * 如果name的值是三种字符串中的一个，value需要做转化
	 * @Title: convertScheduled
	 * @Description: TODO
	 * @param name
	 * @param value
	 * @return
