...
public class MessageId implements DataStructure, Comparable<MessageId> {
	 ...
	 */
	/**
	 * 传递过来的messageKey必须符合一种结构才可以，中间必须有“：”
	 * @Title: setValue
	 * @Description: TODO
	 * @param messageKey
	 * @return: void
	...
	/**
	 * 是一个复制方法，新建一个对象，然后将本对象的属性一个一个赋值过去
	 * @Title: copy
	 * @Description: TODO
	 * @return
	 * @return: MessageId
	...
	/**
	 * Sets a locator which aids a message store in loading a message faster. Only used by the
	 * message stores.
	 */
