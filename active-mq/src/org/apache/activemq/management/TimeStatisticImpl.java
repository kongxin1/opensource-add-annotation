...
/**
 * 时间计数器
 * @ClassName: TimeStatisticImpl
 * @Description: TODO
 * @author: 孔新
 * @date: 2016年7月7日 下午9:40:34
 */
public class TimeStatisticImpl extends StatisticImpl {
	...
	/**
	 * @return the average time calculated by dividing the total time by the number of counts
	 */
	/**
	 * 返回每次增加的平均时间
	 * @Title: getAverageTime
	 * @Description: TODO
	 * @return
	 * @return: double
	 */
	...
	/**
	 * @return the average time calculated by dividing the total time by the number of counts but
	 *         excluding the minimum and maximum times.
	 */
	/**
	 * 在除去最大时间和最小时间后的平均每次增加的时间
	 * @Title: getAverageTimeExcludingMinMax
	 * @Description: TODO
	 * @return
	 * @return: double
	 */
