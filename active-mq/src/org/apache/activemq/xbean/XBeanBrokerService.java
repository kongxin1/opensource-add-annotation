 ...
 */
/**
 * 默认情况下创建的对象，对象创建完毕后，还需要手动调用start方法，对该对象进行启动 ，这是activemq的核心对象
 * @ClassName: XBeanBrokerService
 * @Description: TODO
 * @author: 孔新
 * @date: 2016年7月3日 下午2:16:58
 */
public class XBeanBrokerService extends BrokerService {
	 ...
	 * afterPropertiesSet, done to prevent backwards incompatible signature change.
	 */
	@PostConstruct
	...
	/**
	 * JSR-250 callback wrapper; converts checked exceptions to runtime exceptions delegates to
	 * destroy, done to prevent backwards incompatible signature change.
	 */
	@PreDestroy
	...
	/**
	 * Sets whether or not the broker is started along with the ApplicationContext it is defined
	 * within. Normally you would want the broker to start up along with the ApplicationContext but
	 * sometimes when working with JUnit tests you may wish to start and stop the broker explicitly
	 * yourself.
	 */
