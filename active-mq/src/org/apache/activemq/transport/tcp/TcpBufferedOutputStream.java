 ...
 */
/**
 * 向底层流对象中写入数据，本对象可以缓存数据，当缓存数组满的时候，才会写入底层流中
 * @ClassName: TcpBufferedOutputStream
 * @Description: TODO
 * @author: 孔新
 * @date: 2016年7月17日 下午6:21:50
 */
public class TcpBufferedOutputStream extends FilterOutputStream implements TimeStampStream {
	...
	/**
	 * flush the data to the output stream This doesn't call flush on the underlying outputstream,
	 * because Tcp is particularly efficent at doing this itself ....
	 * @throws IOException
	 */
