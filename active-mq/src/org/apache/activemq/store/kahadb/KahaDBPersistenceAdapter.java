...
/**
 * An implementation of {@link PersistenceAdapter} designed for use with KahaDB - Embedded
...
public class KahaDBPersistenceAdapter extends LockableServiceSupport implements PersistenceAdapter, JournaledStore,
	...
	@Override
	/**
	 * 用于将内存中的数据回写磁盘，这些数据是已经提交的，但是还没有写入磁盘中，这个先不看
	 */
	...
	public void removeQueueMessageStore(ActiveMQQueue destination) {
		this.letter.removeQueueMessageStore(destination);// 空实现
	}
	/**
	 * @param destination
	...
	public void removeTopicMessageStore(ActiveMQTopic destination) {
		this.letter.removeTopicMessageStore(destination);// 空实现
	}
	/**
	 * @param context
	 * @throws IOException
	...
	public void rollbackTransaction(ConnectionContext context) throws IOException {
		this.letter.rollbackTransaction(context);// 不能进行事务回滚，回滚抛出异常
	}
	/**
	 * @param brokerName
	...
	public void doStop(ServiceStopper stopper) throws Exception {
		...
		if (brokerService != null && brokerService.isUseJmx()) {
			...
			brokerService.getManagementContext().unregisterMBean(
					createPersistenceAdapterName(brokerObjectName.toString(), toString()));
		}
	}
	/**
	...
	/**
	 * Set the indexWriteBatchSize When set using Xbean, values of the form "20 Mb", "1024kb", and
	 * "1g" can be used
	...
	/**
	 * Set the journalMaxWriteBatchSize * When set using Xbean, values of the form "20 Mb",
	 * "1024kb", and "1g" can be used
	 * @org.apache.xbean.Property propertyEditor="org.apache.activemq.util.MemoryPropertyEditor"
	 ...
	 * @param indexDirectory the directory where the KahaDB store index files should be written.
	 */
	...
	/**
	 * Set the indexCacheSize When set using Xbean, values of the form "20 Mb", "1024kb", and "1g"
	 * can be used
	 * @org.apache.xbean.Property propertyEditor="org.apache.activemq.util.MemoryPropertyEditor"
