...
/**
 * Keeps track of a added long values. Collapses ranges of numbers using a Sequence representation.
 * Use to keep track of received message ids to find out if a message is duplicate or if there are
...
public class SequenceSet extends LinkedNodeList<Sequence> implements Iterable<Long> {
	 ...
	 * @return a sequence that is count range large, or null if no sequence is that large in the
	 *         list.
	 */
	 ...
	 * @return the total number of values contained in this set if it were to be iterated over like
	 *         an array.
	 */
