 ...
 */
/**
 * 一个双向链表实现，每一个节点都持有整个链表的引用
 * @ClassName: LinkedNode
 * @Description: TODO
 * @author: 孔新
 * @date: 2016年8月14日 下午3:29:14
 * @param <T>
 */
public class LinkedNode<T extends LinkedNode<T>> {
	...
	/**
	 * @param node the node to link after this node.
	 * @return this
	 */
	...
	/**
	 * @param rightList the node to link after this node.
	 * @return this
	 */
	...
	/**
	 * @param leftList the node to link after this node.
	 * @return
	 * @return this
	 */
	...
	/**
	 * Splits the list into 2 lists. This node becomes the tail of this list. Then 2nd list is
	 * returned.
	...
	/**
	 * Splits the list into 2 lists. This node becomes the head of this list. Then 2nd list is
	 * returned.
