...
public class DataByteArrayOutputStream extends OutputStream implements DataOutput {
	...
	/**
	 * This method is called after each write to the buffer. This should allow subclasses to take
	 * some action based on the writes, for example flushing data to an external system based on
	 * size.
	 */
