...
/**
 * 提供一些方法，但是这些方法很多都是空实现，本类基本没有具体的逻辑，只有一个FUTURE属性需要关注
 * @ClassName: AbstractMessageStore
 * @Description: TODO
 * @author: 孔新
 * @date: 2016年7月6日 上午8:17:55
 */
abstract public class AbstractMessageStore implements MessageStore {
	...
	@Override
	public void addMessage(final ConnectionContext context, final Message message, final boolean canOptimizeHint)
			throws IOException {
	...
	@Override
	public ListenableFuture<Object> asyncAddQueueMessage(final ConnectionContext context, final Message message,
			final boolean canOptimizeHint) throws IOException {
