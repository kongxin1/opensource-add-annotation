...
/**
 * 在记录ConnectionInfo对象的同时，会创建SessionInfo对象，
 * @ClassName: ConnectionState
 * @Description: TODO
 * @author: 孔新
 * @date: 2016年7月23日 下午12:39:31
 */
public class ConnectionState {
	...
	// 保存了在本连接下的所有session信息
	private final ConcurrentMap<SessionId, SessionState> sessions = new ConcurrentHashMap<SessionId, SessionState>();
	private final List<DestinationInfo> tempDestinations = Collections
			.synchronizedList(new ArrayList<DestinationInfo>());
