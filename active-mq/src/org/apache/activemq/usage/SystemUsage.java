 ...
 */
/**
 * 本类相当于一个Usage对象的管理器，里面存储了MemoryUsage，StoreUsage，TempUsage，JobSchedulerUsage。本类可以对以上四个对象进行统一启动，
 * 终止和设置某些属性的操作
 * @ClassName: SystemUsage
 * @Description: TODO
 * @author: 孔新
 * @date: 2016年7月11日 下午8:25:39
 */
public class SystemUsage implements Service {
	...
	@Override
	/**
	 * 如果父对象不为null，就将本对象加入父对象中，作为父对象的子对象，然后启动本对象中的所有Usage对象
	 */
	public void start() {
		if (parent != null) {
	...
	@Override
	/**
	 * 如果父对象不为null，就将本对象从父对象的子对象集合中删除，然后将本对象中的所有Usage对象停止
	 */
	public void stop() {
		if (parent != null) {
	...
	/**
	 * Sets whether or not a send() should fail if there is no space free. The default value is
	 * false which means to block the send() method until space becomes available
	 */
	/**
	 * @Title: setSendFailIfNoSpace
	 * @Description: TODO
	 ...
	 */
	/**
	 * 给本对象中的所有Usage对象设置ThreadPoolExecutor对象
	 * @Title: setExecutor
	 * @Description: TODO
	 * @param executor
	 * @return: void
