...
public class TaskRunnerFactory implements Executor {
	...
	// 线程池中线程名字的一部分，创建一个线程下面这个值就增加1
	private final AtomicLong id = new AtomicLong(0);
	// 是否创建一个线程池，如果为true，就不创建
	...
	// 不能加入线程池的线程的处理handler，这个属性会被放入线程中，由线程池自动调用
	...
	/**
	 * 根据属性或者系统参数是否创建一个线程池，就是设置executor属性
	 * @Title: init
	 * @Description: TODO
	 * @return: void
	 */
	 ...
	 */
	/**
	 * 使用线程池工具类关闭线程池，具体的关闭逻辑和shutdownGraceful方法是一样的
	 * @Title: shutdown
	 * @Description: TODO
	 * @return: void
	 */
	...
	/**
	 * 执行线程，这个线程可以在线程池中执行，也可以是一个独立的线程
	 * @Title: execute
	 * @Description: TODO
	 * @param runnable
	 * @param name
