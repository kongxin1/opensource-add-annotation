 ...
 */
/**
 * 这个类中存储了一个字节数组，使用字节数组保存所有的内容，很简单的一个类
 * @ClassName: SerializeWriter
 * @Description: TODO
 * @author: 孔新
 * @date: 2016年9月11日 下午11:03:26
 */
public final class SerializeWriter extends Writer {
	...
	/**
	 * 就是一些字符串替换
	 * @Title: writeStringWithDoubleQuote
	 * @Description: TODO
	 * @param text
	 * @param seperator
	 * @return: void
	...
	/**
	 * 对入参text做特殊处理，如果有特殊字符就加上双引号
	 * @Title: writeKeyWithDoubleQuote
	 * @Description: TODO
	 * @param text
	 * @param checkSpecial
	 * @return: void
	...
	/**
	 * 对入参做出一些特殊处理，name和value之间使用‘:’分隔，
	 * @Title: writeFieldValue
	 * @Description: TODO
	 * @param seperator
	 * @param name
	 * @param value
	...
	/**
	 * 将入参做特殊处理：'text':，对text内部的字符做特殊处理，特殊处理就是在特殊字符前加上'\'
	 * @Title: writeKeyWithSingleQuote
	 * @Description: TODO
	 * @param text
	 * @return: void
	 */
	...
	/**
	 * 如果text中有特殊字符，才加上单引号，如果没有特殊字符，就不加单引号了
	 * @Title: writeKeyWithSingleQuoteIfHasSpecial
	 * @Description: TODO
	 * @param text
	 * @return: void
	 */
