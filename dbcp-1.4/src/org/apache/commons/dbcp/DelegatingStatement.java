 ...
 * <p>
 * All of the methods from the {@link Statement} interface simply check to see that the
 * {@link Statement} is active, and call the corresponding method on the "delegate" provided in my
 * constructor.
 * <p>
 * Extends AbandonedTrace to implement Statement tracking and logging of code which created the
 * Statement. Tracking the Statement ensures that the Connection which created it can close any open
...
public class DelegatingStatement extends AbandonedTrace implements Statement {
	...
	/**
	 * Create a wrapper for the Statement which traces this Statement to the Connection which
	 * created it and the code which created it.
	...
	/**
	 * If my underlying {@link Statement} is not a <tt>DelegatingStatement</tt>, returns it,
	 * otherwise recursively invokes this method on my delegate.
	 * <p>
	 * Hence this method will return the first delegate that is not a <tt>DelegatingStatement</tt>
	 * or <tt>null</tt> when no non-<tt>DelegatingStatement</tt> delegate can be found by
	 * transversing this chain.
	 * <p>
	 * This method is useful when you may have nested <tt>DelegatingStatement</tt>s, and you want to
	 * make sure to obtain a "genuine" {@link Statement}.
	 * @see #getDelegate
	 */
	...
	/*
	 * Note was protected prior to JDBC 4 TODO Consider adding build flags to make this protected
