...
/**
 * A {@link Driver} implementation that obtains {@link Connection}s from a registered
 * {@link ObjectPool}.
...
public class PoolingDriver implements Driver {
	...
	/**
	 * WARNING: This method throws DbcpExceptions (RuntimeExceptions) and will be replaced by the
	 * protected getConnectionPool method.
	 ...
	 * @throws SQLException if the connection is not a <code>PoolGuardConnectionWrapper</code> or an
	 *             error occurs invalidating the connection
	 * @since 1.2.2
	 */
	...
	/**
	 * PoolGuardConnectionWrapper is a Connection wrapper that makes sure a closed connection cannot
	 * be used anymore.
	 */
