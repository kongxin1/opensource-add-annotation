 ...
 * <p>
 * All of the methods from the {@link ResultSet} interface simply call the corresponding method on
 * the "delegate" provided in my constructor.
 * <p>
 * Extends AbandonedTrace to implement result set tracking and logging of code which created the
 * ResultSet. Tracking the ResultSet ensures that the Statment which created it can close any open
...
public class DelegatingResultSet extends AbandonedTrace implements ResultSet {
	...
	/**
	 * Create a wrapper for the ResultSet which traces this ResultSet to the Statement which created
	 * it and the code which created it.
	...
	/**
	 * Create a wrapper for the ResultSet which traces this ResultSet to the Connection which
	 * created it (via, for example DatabaseMetadata, and the code which created it.
	...
	/**
	 * Wrapper for close of ResultSet which removes this result set from being traced then calls
	 * close on the original ResultSet.
	 */
