 ...
 * do nothing, return a value indicating it is unsupported or throw
...
public abstract class BaseObjectPool implements ObjectPool {
	...
	/**
	 * Invalidates an object from the pool. By contract, <code>obj</code> <strong>must</strong> have
	 ...
	 * {@link UnsupportedOperationException}, subclasses should override this behavior.
	 * @throws UnsupportedOperationException
	 */
